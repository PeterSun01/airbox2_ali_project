airbox2 ali cloud with TFT 2.8' 

about tft :sunhao add note

http://note.youdao.com/noteshare?id=931b4bb77bc299eb740a6a088e84b635&sub=27F8985EB61C462EAED97482EDCF1526

#define PIN_NUM_MISO 14		// SPI MISO
#define PIN_NUM_MOSI 27		// SPI MOSI
#define PIN_NUM_CLK  33		// SPI CLOCK pin
#define PIN_NUM_CS   26		// Display CS pin
#define PIN_NUM_DC   25		// Display command/data pin
...
#define PIN_NUM_RST  32  	// GPIO used for RESET control
