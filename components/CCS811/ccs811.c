...
static int ccs811_data_write (uint8_t bus, uint8_t addr, const uint8_t *reg, uint8_t *data, uint32_t len);
static int ccs811_data_read (uint8_t bus, uint8_t addr, const uint8_t *reg, uint8_t *data, uint32_t len);
...
int ccs811_data_write (uint8_t bus, uint8_t addr, const uint8_t *reg, 
...
int ccs811_data_read (uint8_t bus, uint8_t addr, const uint8_t *reg, 
                    uint8_t *data, uint32_t len)
{
...
static bool ccs811_reg_read(ccs811_sensor_t* dev, uint8_t reg, uint8_t *data, uint32_t len)
{
    ...
    int result = ccs811_data_read(dev->bus, dev->addr, &reg, data, len);
...
#   endif
    ...
    int result = ccs811_data_write(dev->bus, dev->addr, &reg, data, len);
